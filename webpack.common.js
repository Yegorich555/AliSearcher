        ...
        // rules for style-files
        {
          ...
          use: [
                ...
                modules: {
                  ...
                  getLocalIdent: isDevMode
                    ...
                    : MinifyCssNames(
                        ...
                        { prefix: "als_", excludePattern: /[_dD]/gi } // exclude '_','d','D' because Adblock blocks '%ad%' classNames
                      )
                }
              }
            },
            {
              ...
              options: {
                prependData: '@import "setup";', // inject this import by default in each scss-file
                sassOptions: {
